...
public record NewsClientProperties(
        @NotNull URI baseUrl,
    ...
    @AssertTrue(message = "news.client.base-url must be an absolute HTTP(S) URL without credentials, a query, or a fragment")
    ...
    @AssertTrue(message = "timeouts must be positive and at most 60 seconds; News needs at least 15 seconds overall")
    ...
    @AssertTrue(message = "news.client.retry-backoff must be positive and no greater than 5 seconds")
